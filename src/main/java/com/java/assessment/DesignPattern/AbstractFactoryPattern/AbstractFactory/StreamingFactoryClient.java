...
public class StreamingFactoryClient {
    public static void main(String[] args) {
        ...
        afc.printHulu(huluFactory.huluPackageDetails("1/Bruce Banner/20170525"));
        StreamingFactory netflixFactory = StreamingFactory.StreamingService(StreamingFactory.StreamingService.NETFLIX);
        afc.printNetflix(netflixFactory.netflixPackageDetails("1/Peter Parker/20171015"));
